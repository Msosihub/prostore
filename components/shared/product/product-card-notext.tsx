...
const ProductCardNoText = ({
  ...
  return (
    <Card className="w-full max-w-sm overflow-hidden group  border-transparent ">
      ...
      <CardContent className="p-1 sm:p-4 grid gap-1 sm:gap-2 text-xs sm:text-sm hidden">
